...
##################STEP1##################
step1:
@splitname=seqsplit($infile,500,150);
##################STEP2##################
step2:
...
-l, --Level=<1..20>(defaults to 15)
-p, --prilengthlimit=<limit to the pri-miRNA length> (defaults to 60)
-d, --directory of share data (defaults to /usr/local/share/miRPara/)
...
sub head{
   ...
   $head.= 'Report bugs to weasteam@gmail.com or sraynere@wh.iov.cn'."\n";
